...
class Envira_Gallery_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        $widget_ops = apply_filters( 'envira_gallery_widget_ops',
            array(
        ...
        $control_ops = apply_filters( 'envira_gallery_widget_control_ops',
            array(
        ...
        $this->WP_Widget( 'envira-gallery', apply_filters( 'envira_gallery_widget_name', __( 'Envira Gallery', 'envira-gallery' ) ), $widget_ops, $control_ops );
