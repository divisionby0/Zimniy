...
class Envira_Gallery {
    ...
    public function require_updater() {
        ...
        $envira_gallery_updater = new Envira_Gallery_Updater( $args );
    ...
    public function _get_gallery( $id ) {
        ...
        return get_post_meta( $id, '_eg_gallery_data', true );
    ...
    public function _get_galleries() {
        ...
        foreach ( $galleries as $id ) {
            ...
            if ( empty( $data['gallery'] ) && 'default' == Envira_Gallery_Shortcode::get_instance()->get_config( 'type', $data ) || 'dynamic' == Envira_Gallery_Shortcode::get_instance()->get_config( 'type', $data ) ) {
                continue;
            }
