...
class Envira_Gallery_Metaboxes {
    ...
    public function do_default_display( $post ) {
        ...
        Envira_Gallery_Media::get_instance()->media_upload_form();
                        ...
                        <div class="media-frame envira-gallery-media-frame wp-core-ui hide-menu envira-gallery-meta-wrap">
                            ...
                            <div class="media-frame-router">
                                <div class="media-router">
                                    <a href="#" class="media-menu-item active"><?php _e( 'Library Images', 'envira-gallery' ); ?></a>
                                    ...
                                    <div class="attachments-browser">
                                        <div class="media-toolbar envira-gallery-library-toolbar">
                                            ...
                                            <div class="media-toolbar-secondary">
                                                <a class="button media-button button-large button-secodary envira-gallery-load-library" href="#" data-envira-gallery-offset="20"><?php _e( 'Load More Images from Library', 'envira-gallery' ); ?></a><span class="spinner envira-gallery-spinner"></span>
                                            </div>
                                        </div>
        ...
        <div id="envira-config">
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr id="envira-config-mobile-size-box" style="display:none;">
                        <th scope="row">
        ...
        <div id="envira-lightbox">
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr id="envira-config-lightbox-toolbar-position-box" style="display:none;">
                        <th scope="row">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="envira-gallery-title-box-<?php echo $id; ?>" valign="middle">
                                                ...
                                                <td>
                                                    ...
                                                    <p class="description"><?php _e( 'Sets the image title attribute for the image.', 'envira-gallery' ); ?></p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr id="envira-gallery-caption-box-<?php echo $id; ?>" valign="middle">
                                                <th scope="row"><label for="envira-gallery-caption-<?php echo $id; ?>"><?php _e( 'Image Caption', 'soliloquy' ); ?></label></th>
                                                <td>
                                                    <?php wp_editor( ( ! empty( $data['caption'] ) ? $data['caption'] : '' ), 'envira-gallery-caption-' . $id, array( 'media_buttons' => false, 'wpautop' => false, 'tinymce' => false, 'textarea_name' => '_envira_gallery[meta_caption]', 'quicktags' => array( 'buttons' => 'strong,em,link,ul,ol,li,close' ) ) ); ?>
                                                    <p class="description"><?php _e( 'Image captions can take any type of HTML.', 'envira-gallery' ); ?></p>
                                                </td>
                                            </tr>
